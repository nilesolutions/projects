...
function initTabs() {
	...
	jQuery('ul.tabset-2').tabset({
		tabLinks: 'a',
		defaultTab: false
	});
	jQuery('ul.tabset-3').tabset({
		tabLinks: 'a',
		defaultTab: false
	});
}
...
function initAnchors() {
	new SmoothScroll({
		anchorLinks: 'a.anchors[href^="#"]:not([href="#"])'
	});
}
 ...
 */
!function(e){"function"==typeof define&&define.amd?define(["jquery"],
	e):e(jQuery)}(function(e){function t(e){for(var t,i;e.length&&e[0]!==document;){if(t=e.css("position"),("absolute"===t||"relative"===t||"fixed"===t)&&(i=parseInt(e.css("zIndex"),10),!isNaN(i)&&0!==i))return i;e=e.parent()}return 0}function i(){this._curInst=null,this._keyEvent=!1,this._disabledInputs=[],this._datepickerShowing=!1,this._inDialog=!1,
	...
	monthNamesShort:["янв","фев","март","апр","мая","июня","июля","авг","сент","окт","нояб","дек"],
